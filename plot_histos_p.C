...
void plot_histos_p()
{
    TFile *rf = new TFile("ex-p180.root");
    ...
    std::string histo_names[] = {"pri_p_dep_E_1",
                        ...
                        "el_dep_E_1"};
    std::string histo_labels[] = {"Primary Protons",
    ...
    tot_dep_E->SetTitle("Protons 180 MeV Relative Dose Profile");
