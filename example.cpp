...
test_an::test_an()
{
    tot_dep_E = new TH1F("tot_dep_E","total energy dep.",100,0.,100.);
    sec_hi_dep_E = new TH1F("sec_hi_dep_E","secondary HI energy dep.",100,0.,100.);
    pri_hi_dep_E = new TH1F("pri_hi_dep_E","primary HI energy dep.",100,0.,100.);
    electr_dep_E = new TH1F("el_dep_E","electrons energy dep.",100,0.,100.);
    prot_dep_E = new TH1F("p_dep_E","protons energy dep.",100,0.,100.);
    alpha_dep_E = new TH1F("alpha_dep_E","alpha energy dep.",100,0.,100.);
    
    tot_dep_E_2d = new TH2F("tot_dep_E","total energy dep.",100,0.,100.,101,-5.05,5.05);
    sec_hi_dep_E_2d = new TH2F("sec_hi_dep_E","secondary HI energy dep.",100,0.,100.,101,-5.05,5.05);
    pri_hi_dep_E_2d = new TH2F("pri_hi_dep_E","primary HI energy dep.",100,0.,100.,101,-5.05,5.05);
    electr_dep_E_2d = new TH2F("el_dep_E","electrons energy dep.",100,0.,100.,101,-5.05,5.05);
    prot_dep_E_2d = new TH2F("p_dep_E","protons energy dep.",100,0.,100.,101,-5.05,5.05);
    alpha_dep_E_2d = new TH2F("alpha_dep_E","alpha energy dep.",100,0.,100.,101,-5.05,5.05);
...
void test_an::Analyse_Track_Record(first_rec_case_1 &rec, SimpleFlukaTrack *trk, bool is_beam_particle)
{
    ...
    tot_dep_E->Fill(trk->Segmets_ends[1].z,trk->energy_deposition_events[0]);
